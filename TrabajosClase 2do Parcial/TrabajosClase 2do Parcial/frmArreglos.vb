Public Class frmArreglos
    ...
    Private Sub frmArreglos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txtRcantidad.Enabled = False
    End Sub

    Private Sub btnRegistrar_Click(sender As Object, e As EventArgs) Handles btnRegistrar.Click
        If IsNumeric(txtCantidadIngresar.Text) Then
    ...
    Public Sub mostrarDatos(ByVal indice)
        ...
        txtModelo.Text = mComputadoras(indice, 1)
        txtPrecio.Text = mComputadoras(indice, 2)
        txtRcantidad.Text = mComputadoras(indice, 3)
    End Sub
End Class